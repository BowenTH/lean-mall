...
class Visitor extends sonarAnalysis_1.SonarRuleVisitor {
    ...
    visitAccessor(accessor, setterOrGetter) {
        ...
        if (accessorIsPublic &&
            ...
            this.addIssue(accessor.name, `Refactor this ${setterOrGetter.type} so that it actually refers to the property '${matchingFields[0]
                .name.getText()}'`).addSecondaryLocation(matchingFields[0], "Property which should be referred.");
        }
    }
